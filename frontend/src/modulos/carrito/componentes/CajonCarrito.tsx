...
import {
  generarEnlaceInstagram,
  copiarAlPortapapeles,
} from '../utilidades/generarEnlaceInstagram';
...
export default function CajonCarrito() {
  ...
  // Evitar hydration mismatch con Zustand persist sin render en cascada
  ...
  const handleIrAInstagram = async () => {
    ...
    setCopiado(exito);
    vaciar();
    window.open(generarEnlaceInstagram(), '_blank', 'noopener,noreferrer');
    setTimeout(() => { cerrarCarrito(); setCopiado(false); }, 2500);
  };
          ...
          <div className="cajon-confirmacion">
            ...
            <div className="confirmacion-aviso">
              ...
              <p className="confirmacion-aviso-texto">
                Elige tu canal preferido (WhatsApp o Instagram). Tu pedido irá listo para enviar y el pago por SINPE Móvil se coordina por ese mismo chat.
              </p>
            </div>

            <div className="cajon-botones-canal">
              ...
              <button onClick={handleIrAInstagram} className="cajon-btn-instagram">
                <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 20, height: 20 }}>
              ...
              {copiado && (
                <p className="cajon-nota-copiado">
                  ✓ Mensaje copiado — pégalo en el chat de Instagram que se acaba de abrir.
                </p>
              )}
            </div>
          </div>
